...
class Tag {
  ...
  Tag(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _taglib_file_newPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<TagLib_File> Function(
              ffi.Pointer<ffi.Int8>)>>('taglib_file_new');
  late final _taglib_file_new = _taglib_file_newPtr
      .asFunction<ffi.Pointer<TagLib_File> Function(ffi.Pointer<ffi.Int8>)>(
          isLeaf: true);

  ffi.Pointer<TagLib_File> taglib_file_new_utf16(
    ffi.Pointer<ffi.WChar> src,
  ) {
    return _taglib_file_new_utf16(
      src,
    );
  }

  late final _taglib_file_new_utf16Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<TagLib_File> Function(
              ffi.Pointer<ffi.WChar>)>>('taglib_file_new_utf16');
  late final _taglib_file_new_utf16 = _taglib_file_new_utf16Ptr
      .asFunction<ffi.Pointer<TagLib_File> Function(ffi.Pointer<ffi.WChar>)>(
          isLeaf: true);
  ...
  late final _taglib_file_new_typePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<TagLib_File> Function(
              ffi.Pointer<ffi.Int8>, ffi.Int32)>>('taglib_file_new_type');
  late final _taglib_file_new_type = _taglib_file_new_typePtr.asFunction<
      ffi.Pointer<TagLib_File> Function(
          ffi.Pointer<ffi.Int8>, int)>(isLeaf: true);
  ...
  late final _taglib_file_free = _taglib_file_freePtr
      .asFunction<void Function(ffi.Pointer<TagLib_File>)>(isLeaf: true);
  ...
  late final _taglib_file_is_validPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<TagLib_File>)>>(
          'taglib_file_is_valid');
  late final _taglib_file_is_valid = _taglib_file_is_validPtr
      .asFunction<int Function(ffi.Pointer<TagLib_File>)>(isLeaf: true);
  ...
  late final _taglib_file_audioproperties =
      _taglib_file_audiopropertiesPtr.asFunction<
          ffi.Pointer<TagLib_AudioProperties> Function(
              ffi.Pointer<TagLib_File>)>(isLeaf: true);
  ...
  ffi.Pointer<ffi.Int8> taglib_tag_title(
  ...
  late final _taglib_tag_title = _taglib_tag_titlePtr
      .asFunction<ffi.Pointer<ffi.Int8> Function(ffi.Pointer<TagLib_Tag>)>(
          isLeaf: true);
  ...
  /// \note By default this string should be UTF8 encoded and its memory should be
  /// freed using taglib_tag_free_strings().
  ffi.Pointer<ffi.Int8> taglib_tag_artist(
    ffi.Pointer<TagLib_Tag> tag,
  ) {
  ...
  /// \note By default this string should be UTF8 encoded and its memory should be
  /// freed using taglib_tag_free_strings().
  ffi.Pointer<ffi.Int8> taglib_tag_album(
    ffi.Pointer<TagLib_Tag> tag,
  ) {
  ...
  /// \note By default this string should be UTF8 encoded and its memory should be
  /// freed using taglib_tag_free_strings().
  ffi.Pointer<ffi.Int8> taglib_tag_comment(
    ffi.Pointer<TagLib_Tag> tag,
  ) {
  ...
  /// \note By default this string should be UTF8 encoded and its memory should be
  /// freed using taglib_tag_free_strings().
  ffi.Pointer<ffi.Int8> taglib_tag_genre(
    ffi.Pointer<TagLib_Tag> tag,
  ) {
  ...
  late final _taglib_tag_yearPtr =
      _lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<TagLib_Tag>)>>(
          'taglib_tag_year');
  late final _taglib_tag_year = _taglib_tag_yearPtr
      .asFunction<int Function(ffi.Pointer<TagLib_Tag>)>(isLeaf: true);
  ...
  late final _taglib_tag_set_titlePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<TagLib_Tag>,
              ffi.Pointer<ffi.Int8>)>>('taglib_tag_set_title');
  late final _taglib_tag_set_title = _taglib_tag_set_titlePtr.asFunction<
      void Function(
          ffi.Pointer<TagLib_Tag>, ffi.Pointer<ffi.Int8>)>(isLeaf: true);
  ...
  late final _taglib_tag_set_artistPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<TagLib_Tag>,
              ffi.Pointer<ffi.Int8>)>>('taglib_tag_set_artist');
  ...
  late final _taglib_tag_set_albumPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<TagLib_Tag>,
              ffi.Pointer<ffi.Int8>)>>('taglib_tag_set_album');
  ...
  late final _taglib_tag_set_commentPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<TagLib_Tag>,
              ffi.Pointer<ffi.Int8>)>>('taglib_tag_set_comment');
  ...
  late final _taglib_tag_set_genrePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<TagLib_Tag>,
              ffi.Pointer<ffi.Int8>)>>('taglib_tag_set_genre');
  ...
  late final _taglib_tag_set_yearPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<TagLib_Tag>, ffi.Uint32)>>('taglib_tag_set_year');
  late final _taglib_tag_set_year = _taglib_tag_set_yearPtr
      .asFunction<void Function(ffi.Pointer<TagLib_Tag>, int)>(isLeaf: true);
  ...
  late final _taglib_tag_set_trackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<TagLib_Tag>, ffi.Uint32)>>('taglib_tag_set_track');
  ...
  late final _taglib_tag_free_strings =
      _taglib_tag_free_stringsPtr.asFunction<void Function()>(isLeaf: true);
  ...
  late final _taglib_audioproperties_lengthPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int32 Function(ffi.Pointer<TagLib_AudioProperties>)>>(
  ...
  late final _taglib_id3v2_set_default_text_encoding =
      _taglib_id3v2_set_default_text_encodingPtr.asFunction<void Function(int)>(
          isLeaf: true);
}
